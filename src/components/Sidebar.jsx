...
const Sidebar = () => {
    ...
    return (
        <div className="relative hidden basis-[20rem] h-screen mb-4 ml-4 shadow-lg lg:block w-80">
            <div className="h-full bg-white rounded-2xl dark:bg-gray-700">
                <div className="flex items-center justify-center border-b h-[5rem]">
                ...
                <nav className="mt-6">
                    <div>
                        ...
                        <Link to="/verification" className={`flex items-center justify-start w-full p-4 my-2 font-thin uppercase ${path === '/verification' && 'text-blue-500 transition-colors duration-200 border-r-4 border-blue-500 bg-gradient-to-r from-white to-blue-100 dark:from-gray-700 dark:to-gray-800'}`} href="#">
                            <span className="text-left">
                        ...
                        <Link to="/candidates" className={`flex items-center justify-start w-full p-4 my-2 font-thin uppercase ${path === '/candidates' && 'text-blue-500 transition-colors duration-200 border-r-4 border-blue-500 bg-gradient-to-r from-white to-blue-100 dark:from-gray-700 dark:to-gray-800'}`} href="#">
                            <span className="text-left">
